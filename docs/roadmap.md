...
|---|---|---|
| 1. Retrieval foundation | Unit tests, golden dataset, Recall@K/MRR/nDCG, API contract | In development |
| 2. pgvector integration | Migration, filtered hybrid queries, integration tests, latency baseline | Planned |
